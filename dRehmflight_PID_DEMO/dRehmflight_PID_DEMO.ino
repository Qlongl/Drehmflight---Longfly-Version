...
float B_madgwick = 1.0;  //Madgwick filter parameter
...
float GyroErrorX = -5.61;
float GyroErrorY = -1.31;
float GyroErrorZ = -13.58;
...
float Ki_roll_angle = 0.2;    //Roll I-gain - angle mode
...
//qlong4
  ...
  m1_command_scaled = 0; //thro_des - pitch_PID + roll_PID + yaw_PID; //Front Left
  m2_command_scaled = 0; //thro_des - pitch_PID - roll_PID - yaw_PID; //Front Right
  m4_command_scaled = 0; //thro_des + pitch_PID + roll_PID - yaw_PID; //Back Left
  m3_command_scaled = 0; //thro_des + pitch_PID - roll_PID + yaw_PID; //Back Right
  ...
  s1_command_scaled = 0.5 - 10*pitch_PID - 10*roll_PID;
  s2_command_scaled = 0.5 + 10*pitch_PID + 10*roll_PID;
  s3_command_scaled = 0;
  s4_command_scaled = 0;
  s5_command_scaled = 0;
  s6_command_scaled = 0;
